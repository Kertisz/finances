...
const Storage = {
    ...
    set(transactions){
        localStorage.setItem("dev.finances:transacoes", JSON.stringify(transactions))
    },
}
...
const DOM = {
    ...
    innerHTMLTransaction(transaction, index) {
        ...
        const html = `
                        ...
                        <td>
                            <img onclick="Transaction.remove(${index})"src="./assets/minus.svg" alt="remove transation">
                        </td>
        `
        return html
...
const Form = {
    ...
    validateFields() {
        //desconstruindo para acessar os valores dos campos
